...
// TarottuleMFC.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CTarottuleMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CTarottuleMFCApp

CTarottuleMFCApp::CTarottuleMFCApp()
{
...
// Seul et unique objet CTarottuleMFCApp

CTarottuleMFCApp theApp;


// initialisation de CTarottuleMFCApp

BOOL CTarottuleMFCApp::InitInstance()
{
